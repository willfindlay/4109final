...
- Vigenere cipher(polyalphabetic cipher)
    - K=$(Z_{26})^{l}$
    - for k=($k_{1}$,$k_{2}$,...,$k_{l}$) and m=($m_{1}$,$m_{2}$,...,$m_{l}$) in P
    - $E_{k}$($m_{1}$,$m_{2}$,...,$m_{l}$)=($m_{1}$+$k_{1}$,$m_{2}$+$k_{2}$,...,$m_{l}$+$k_{l}$) mod 26
    - $D_{k}$($c_{1}$,$c_{2}$,...,$c_{l}$)=($c_{1}$-$k_{1}$,$c_{2}$-$k_{2}$,...,$c_{l}$-$k_{l}$) mod 26
